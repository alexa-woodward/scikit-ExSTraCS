...
def main(outputFolder, fileCheck, resubmitJobs):
    ...
    instances = [10000,20000,40000] #[5000,10000,10000,20000,40000]
    replications = 30
    ...
    for i in instances:
        for j in range(replications):#(replications)
            ...
            if not os.path.exists(dataName):
                Problem_Multiplexer.generate_mulitplexer_data(dataName, multiplexer, i)
            ...
            if justTrain:
                ...
                realData = dataPath+projectFolder+'/'+dataFolder+'/'+shortName+'.txt'
